...
- Create Angular project with ng: `ng new crashdateheatmap.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`crashdateheatmap.client.esproj`).
